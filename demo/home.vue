    ...
    <header class="demo__header">
      <svg class="demo__logo" viewBox="0 0 454 130" xmlns="http://www.w3.org/2000/svg">
        ...
        <g fill="none" fill-rule="evenodd">
          <g stroke-width="10">
            <path d="M.5 45h20c30 0 30 80 60 80s29.85-110 59.85-110h20.15" stroke="#39AF77"></path>
            <path d="M.5 35h20c34 0 42 80 60 80 22 0 18-110 60-110h20" stroke="#2F4053"></path>
          </g>
          <path
